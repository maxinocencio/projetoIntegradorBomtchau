...
class FormasGeometricas(Toplevel): #Tela escolha de conteudo
    def __init__(self, original): #Inserindo inicialização
        ...
        self.BtnTriangulo = Button(self, image = self.triangulo, borderwidth=0, bg='#7030A0', activebackground = '#7030A0', command = self.somTriangulo).place(relx=0.02, rely=0.18, relwidth=0.46, relheight=0.3)

        self.BtnQuadrado = Button(self, image = self.quadrado, borderwidth=0, bg='#7030A0', activebackground = '#7030A0', command = self.somQuadrado).place(relx=0.52, rely=0.18, relwidth=0.46, relheight=0.3)

        self.BtnRetangulo = Button(self, image = self.retangulo, borderwidth=0, bg='#7030A0', activebackground = '#7030A0', command = self.somRetangulo).place(relx=0.02, rely=0.5, relwidth=0.46, relheight=0.3)

        self.BtnCirculo = Button(self, image = self.circulo, borderwidth=0, bg='#7030A0', activebackground = '#7030A0', command = self.somCirculo).place(relx=0.52, rely=0.5, relwidth=0.46, relheight=0.3)
    ...
    def somTriangulo(self):
        pygame.mixer.music.load('triangulo.mp3')  #função de iniciar o som
        pygame.mixer.music.play()
        StopIteration

    def somQuadrado(self):
        pygame.mixer.music.load('quadrado.mp3')  #função de iniciar o som
        pygame.mixer.music.play()
        StopIteration

    def somRetangulo(self):
        pygame.mixer.music.load('retangulo.mp3')  #função de iniciar o som
        pygame.mixer.music.play()
        StopIteration

    def somCirculo(self):
        pygame.mixer.music.load('circulo.mp3')  #função de iniciar o som
        pygame.mixer.music.play()
        StopIteration
